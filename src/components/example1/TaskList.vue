...
import CreateModal from '@/components/example1/CreateModal.vue';
import TaskListItem from '@/components/example1/TaskListItem.vue';
import TaskItem from '@/components/example1/TaskItem.vue';
import EditModal from '@/components/example1/EditModal.vue';
